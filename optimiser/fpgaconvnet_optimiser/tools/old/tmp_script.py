...
def optim_expr(args,filepath,is_branchy,opt_path,plat_path):
    ...
    if not auto_flag: #one run on partitions at optimiser_example specified rsc usage
        net.rsc_allocation = 1.0 #forcing low rsc usage for debug
    ...
    rsc_limits = [0.4, 0.5, 0.6, 0.7, 0.8, 0.9, 1.0]
    full_sa_runs = 2#10
...
def main():
    ...
    # ALEXNET predicted only
    #filepath = "/home/localadmin/phd/fpgaconvnet-optimiser/examples/models/alexnet_backbone_221214.onnx"
    # TW bb smallcnn predicted only
    #filepath = "/home/localadmin/phd/fpgaconvnet-optimiser/examples/models/tw_bb_221230.onnx"
    # SDN bb resnet 56 predicted only
    #filepath = "/home/localadmin/phd/fpgaconvnet-optimiser/examples/models/SDN_BB_resnet56_no-res.onnx"
    filepath = "/home/localadmin/phd/fpgaconvnet-optimiser/examples/models/SDN_BB_resnet18_no-res.onnx"
