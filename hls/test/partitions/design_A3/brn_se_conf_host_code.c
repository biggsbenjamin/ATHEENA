...
XRelu3_squeeze_convolution31_top lyr21;
XRelu3_squeeze_convolution31_top_Config *lyr21_cfg;
XConvolution31_top lyr22;
XConvolution31_top_Config *lyr22_cfg;
XConvolution31_squeeze_pooling32_top lyr23;
XConvolution31_squeeze_pooling32_top_Config *lyr23_cfg;
XPooling32_top lyr24;
XPooling32_top_Config *lyr24_cfg;
XRelu33_top lyr25;
XRelu33_top_Config *lyr25_cfg;
XRelu33_squeeze_innerproduct35_top lyr26;
XRelu33_squeeze_innerproduct35_top_Config *lyr26_cfg;
...
void initPeriph() {
    ...
    lyr21_cfg = XRelu3_squeeze_convolution31_top_LookupConfig(XPAR_BRN_SE_CONF_NETWORK_RELU3_SQUEEZE_CONVOLUTION31_DEVICE_ID);
    if (lyr21_cfg) {
        int status = XRelu3_squeeze_convolution31_top_CfgInitialize(&lyr21, lyr21_cfg);
        if (status != XST_SUCCESS) {
    ...
    lyr22_cfg = XConvolution31_top_LookupConfig(XPAR_BRN_SE_CONF_NETWORK_CONVOLUTION31_DEVICE_ID);
    if (lyr22_cfg) {
        int status = XConvolution31_top_CfgInitialize(&lyr22, lyr22_cfg);
        if (status != XST_SUCCESS) {
    ...
    lyr23_cfg = XConvolution31_squeeze_pooling32_top_LookupConfig(XPAR_BRN_SE_CONF_NETWORK_CONVOLUTION31_SQUEEZE_POOLING32_DEVICE_ID);
    if (lyr23_cfg) {
        int status = XConvolution31_squeeze_pooling32_top_CfgInitialize(&lyr23, lyr23_cfg);
        if (status != XST_SUCCESS) {
    ...
    lyr25_cfg = XRelu33_top_LookupConfig(XPAR_BRN_SE_CONF_NETWORK_RELU33_DEVICE_ID);
    if (lyr25_cfg) {
        int status = XRelu33_top_CfgInitialize(&lyr25, lyr25_cfg);
        if (status != XST_SUCCESS) {
    ...
    lyr26_cfg = XRelu33_squeeze_innerproduct35_top_LookupConfig(XPAR_BRN_SE_CONF_NETWORK_RELU33_SQUEEZE_INNERPRODUCT35_DEVICE_ID);
    if (lyr26_cfg) {
        int status = XRelu33_squeeze_innerproduct35_top_CfgInitialize(&lyr26, lyr26_cfg);
        if (status != XST_SUCCESS) {
...
int main() {
    ...
    XRelu3_squeeze_convolution31_top_Start(&lyr21);
    XConvolution31_top_Start(&lyr22);
    XConvolution31_squeeze_pooling32_top_Start(&lyr23);
    XPooling32_top_Start(&lyr24);
    XRelu33_top_Start(&lyr25);
    XRelu33_squeeze_innerproduct35_top_Start(&lyr26);
