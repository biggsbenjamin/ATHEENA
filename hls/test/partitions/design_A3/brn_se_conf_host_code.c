...
#include "xpooling17_squeeze_relu18_top.h"
...
XSplit0_squeeze_convolution16_top lyr6;
XSplit0_squeeze_convolution16_top_Config *lyr6_cfg;
XConvolution16_top lyr7;
XConvolution16_top_Config *lyr7_cfg;
XPooling17_top lyr8;
XPooling17_top_Config *lyr8_cfg;
XPooling17_squeeze_relu18_top lyr9;
XPooling17_squeeze_relu18_top_Config *lyr9_cfg;
XRelu18_top lyr10;
...
XRelu3_squeeze_convolution31_top lyr23;
XRelu3_squeeze_convolution31_top_Config *lyr23_cfg;
XConvolution31_top lyr24;
XConvolution31_top_Config *lyr24_cfg;
XConvolution31_squeeze_pooling32_top lyr25;
XConvolution31_squeeze_pooling32_top_Config *lyr25_cfg;
XPooling32_top lyr26;
XPooling32_top_Config *lyr26_cfg;
XRelu33_top lyr27;
XRelu33_top_Config *lyr27_cfg;
XRelu33_squeeze_innerproduct35_top lyr28;
XRelu33_squeeze_innerproduct35_top_Config *lyr28_cfg;
XInnerproduct35_top lyr29;
XInnerproduct35_top_Config *lyr29_cfg;
...
void initPeriph() {
    ...
    lyr6_cfg = XSplit0_squeeze_convolution16_top_LookupConfig(XPAR_BRN_SE_CONF_NETWORK_SPLIT0_SQUEEZE_CONVOLUTION16_DEVICE_ID);
    if (lyr6_cfg) {
        int status = XSplit0_squeeze_convolution16_top_CfgInitialize(&lyr6, lyr6_cfg);
        if (status != XST_SUCCESS) {
    ...
    lyr7_cfg = XConvolution16_top_LookupConfig(XPAR_BRN_SE_CONF_NETWORK_CONVOLUTION16_DEVICE_ID);
    if (lyr7_cfg) {
        int status = XConvolution16_top_CfgInitialize(&lyr7, lyr7_cfg);
        if (status != XST_SUCCESS) {
    ...
    lyr9_cfg = XPooling17_squeeze_relu18_top_LookupConfig(XPAR_BRN_SE_CONF_NETWORK_POOLING17_SQUEEZE_RELU18_DEVICE_ID);
    if (lyr9_cfg) {
        int status = XPooling17_squeeze_relu18_top_CfgInitialize(&lyr9, lyr9_cfg);
        if (status != XST_SUCCESS) {
    ...
    lyr23_cfg = XRelu3_squeeze_convolution31_top_LookupConfig(XPAR_BRN_SE_CONF_NETWORK_RELU3_SQUEEZE_CONVOLUTION31_DEVICE_ID);
    if (lyr23_cfg) {
        int status = XRelu3_squeeze_convolution31_top_CfgInitialize(&lyr23, lyr23_cfg);
        if (status != XST_SUCCESS) {
    ...
    lyr24_cfg = XConvolution31_top_LookupConfig(XPAR_BRN_SE_CONF_NETWORK_CONVOLUTION31_DEVICE_ID);
    if (lyr24_cfg) {
        int status = XConvolution31_top_CfgInitialize(&lyr24, lyr24_cfg);
        if (status != XST_SUCCESS) {
    ...
    lyr25_cfg = XConvolution31_squeeze_pooling32_top_LookupConfig(XPAR_BRN_SE_CONF_NETWORK_CONVOLUTION31_SQUEEZE_POOLING32_DEVICE_ID);
    if (lyr25_cfg) {
        int status = XConvolution31_squeeze_pooling32_top_CfgInitialize(&lyr25, lyr25_cfg);
        if (status != XST_SUCCESS) {
    ...
    lyr26_cfg = XPooling32_top_LookupConfig(XPAR_BRN_SE_CONF_NETWORK_POOLING32_DEVICE_ID);
    if (lyr26_cfg) {
        int status = XPooling32_top_CfgInitialize(&lyr26, lyr26_cfg);
        if (status != XST_SUCCESS) {
    ...
    lyr27_cfg = XRelu33_top_LookupConfig(XPAR_BRN_SE_CONF_NETWORK_RELU33_DEVICE_ID);
    if (lyr27_cfg) {
        int status = XRelu33_top_CfgInitialize(&lyr27, lyr27_cfg);
        if (status != XST_SUCCESS) {
    ...
    lyr28_cfg = XRelu33_squeeze_innerproduct35_top_LookupConfig(XPAR_BRN_SE_CONF_NETWORK_RELU33_SQUEEZE_INNERPRODUCT35_DEVICE_ID);
    if (lyr28_cfg) {
        int status = XRelu33_squeeze_innerproduct35_top_CfgInitialize(&lyr28, lyr28_cfg);
        if (status != XST_SUCCESS) {
            xil_printf("Error initalising layer :28:\n\r");
        }
    }

    xil_printf("Initialising fpgaconvnet layer29\n\r");
    lyr29_cfg = XInnerproduct35_top_LookupConfig(XPAR_BRN_SE_CONF_NETWORK_INNERPRODUCT35_DEVICE_ID);
    if (lyr29_cfg) {
        int status = XInnerproduct35_top_CfgInitialize(&lyr29, lyr29_cfg);
        if (status != XST_SUCCESS) {
            xil_printf("Error initalising layer :29:\n\r");
        }
    }
...
int main() {
    ...
    XSplit0_squeeze_convolution16_top_Start(&lyr6);
    XConvolution16_top_Start(&lyr7);
    XPooling17_top_Start(&lyr8);
    XPooling17_squeeze_relu18_top_Start(&lyr9);
    ...
    XRelu3_squeeze_convolution31_top_Start(&lyr23);
    XConvolution31_top_Start(&lyr24);
    XConvolution31_squeeze_pooling32_top_Start(&lyr25);
    XPooling32_top_Start(&lyr26);
    XRelu33_top_Start(&lyr27);
    XRelu33_squeeze_innerproduct35_top_Start(&lyr28);
    XInnerproduct35_top_Start(&lyr29);
